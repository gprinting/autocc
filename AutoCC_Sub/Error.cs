...
namespace AutoCC_Sub
{
    class Error
    {
        ...
        public const string ArtboartCountOver = "AAAA";
        ...
        public const string PAGE_NOT_EXIST = "0301"; // 주문 사이즈가 일치하지 안는경우
        public const string PAGE_COUNT_NOT_MATCH_TO_DOUBLE_SIDE = "0302";
        public const string PAGE_COUNT_NOT_MATCH_TO_ITEM_COUNT = "0303";

        public const string OVERLAPPED_PAGES_EXIST = "0304";// 프로그램에서 삭제하므로 무시하면된
        ...
        public const string DOCUMENT_WITH_NOT_A_LAYER = "0401"; //레이어가 1개이상
        ...
        public const string OBJECT_WITH_SPOT_COLOR = "0508"; // 프로그램에서 삭제하므로 무시하면된
      ...
      //  public const string OBJECT_Raster_Image = "0533"; //2020.04.29 추가 레스터 이미지가 없는데 계속 있다고 나와서 삭제
        ...
        public const string EFFECT_TRANSPARENCY_USED = "0602"; //이게나오면 0301이 같이 나옴
